...
class sample_generator(nn.Module):
    ...
    def forward(self, z, prev_x, y ,batch_size,pitch_range):
        ...
        h0_prev = self.lrelu(self.bn0_prev(self.h0_prev(prev_x)),0.2)   #[72, 16, 16, 1]
        h1_prev = self.lrelu(self.bn1_prev(self.h1_prev(h0_prev)),0.2)  #[72, 16, 8, 1]
        h2_prev = self.lrelu(self.bn2_prev(self.h2_prev(h1_prev)),0.2)  #[72, 16, 4, 1]
        h3_prev = self.lrelu(self.bn3_prev(self.h3_prev(h2_prev)),0.2)  #[72, 16, 2, 1])
